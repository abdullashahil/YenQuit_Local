...
export function LandingPage() {
  ...
  // Force refresh slider on mount
  // Manual control of slides to show based on window width
  const [slidesToShow, setSlidesToShow] = useState(1); // Default to 1 (mobile-first)
  ...
  // Testimonial slider settings with dynamic slidesToShow
  const testimonialSettings = {
    ...
    pauseOnHover: true,
    arrows: false,
    // We handle responsiveness manually via state to ensure correct rendering on load
  };
  ...
  return (
    <div className={`font-sans text-[#1C3B5E] bg-white scroll-smooth overflow-x-hidden transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className={`fixed inset-0 bg-white z-40 flex flex-col items-center justify-center transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white to-blue-50 relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <button className="bg-gradient-to-r from-[#FFC107] to-[#FFD54F] px-6 sm:px-8 py-3 sm:py-4 rounded-full text-white font-semibold shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl">
                  <Link href="/login">Get Started Free</Link>
                </button>
                <button className="border-2 border-[#1C3B5E] px-6 sm:px-8 py-3 sm:py-4 rounded-full text-[#1C3B5E] font-semibold transition-all duration-300 hover:bg-[#1C3B5E] hover:text-white">
                  Learn More
                </button>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mt-12">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center">
                    <div className="text-xl sm:text-2xl md:text-3xl font-bold text-[#1C3B5E]">{stat.number}</div>
            ...
            <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
              <div className="relative max-w-md lg:max-w-lg">
                <Image
                  ...
                  width={600}
                  height={450}
                  className="rounded-lg object-contain w-full animate-float z-10"
                />
                {/* Floating elements */}
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12 px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6 px-4">
            {steps.map((step, index) => (
              <div
                key={index}
                className="group relative bg-white rounded-2xl p-4 sm:p-6 text-center shadow-lg transition-all duration-500 hover:scale-105 hover:shadow-2xl border border-gray-100"
              >
                ...
                <h4 className="text-base sm:text-lg font-bold text-[#1C3B5E] mb-2">{step.title}</h4>
      ...
      {/* Why Quit */}
      <section id="whyquit" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-snug mt-4">
      ...
      {/* About */}
      <section id="about" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="order-1 lg:order-1">
              ...
              <ul className="space-y-4 sm:space-y-6 text-[#1C3B5E] text-sm sm:text-base leading-relaxed mt-6 sm:mt-8">
                <li className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                  <span className="text-[#FFC107] text-xl sm:text-2xl flex-shrink-0">•</span>
                  <span>
      ...
      <section id="testimonials" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1C3B5E] mb-4 mt-2">
            Read What Others Have To Say
          </h3>
          <p className="text-gray-600 max-w-2xl mx-auto mb-12 px-4">
            Join thousands of successful quitters who have transformed their lives with YenQuit
          </p>

          <div className="relative px-2">
            {isClient && (
              <Slider key={slidesToShow} {...testimonialSettings}>
                  ...
                  <div key={index} className="px-2 sm:px-4 outline-none">
                    <div className="bg-gradient-to-br from-[#1C3B5E] to-[#2D4A6E] text-white rounded-3xl p-6 sm:p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 min-h-[380px] sm:min-h-[420px] flex flex-col justify-between relative overflow-hidden">
                      ...
                      <div>
                        ...
                        <h4 className="font-bold text-base sm:text-lg mb-2">{testimonial.name}</h4>
                        <p className="text-yellow-200 text-xs sm:text-sm mb-4 font-medium">{testimonial.role}</p>

                        <p className="text-gray-200 leading-relaxed text-sm sm:text-base text-center">
                          "{testimonial.text}"
                        </p>
                      </div>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          <div className="bg-gradient-to-r from-[#4A8BB2] via-[#5D9BC6] to-[#C7A74E] text-center text-white rounded-3xl p-8 sm:p-12 md:p-16 relative overflow-hidden">
            {/* Background pattern */}
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-snug mb-6 sm:mb-8 mt-4 max-w-3xl mx-auto px-4">
              Join Hands With Us — Your Journey To A Fresh, Smoke-Free Life Starts Today
            </h3>
            <p className="text-white/80 text-base sm:text-lg mb-8 sm:mb-10 max-w-2xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
              <button className="bg-black text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg tracking-wide shadow-lg hover:scale-105 transition-transform duration-300 hover:shadow-xl z-10">
                <Link href="/login">GET STARTED NOW</Link>
              </button>
              <button className="bg-white/20 text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg tracking-wide backdrop-blur-sm hover:bg-white/30 transition-all duration-300 hover:scale-105 z-10">
      ...
      {/* Enhanced Footer */}
      <footer id="footer" className="bg-gradient-to-b from-white to-blue-50 text-[#1C3B5E] py-16 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12 items-start">
            ...
            <div className="md:col-span-2 lg:col-span-2">
              ...
              <div className="flex space-x-3 sm:space-x-4">
                ...
                <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-full shadow-md flex items-center justify-center text-gray-600 hover:text-[#1877F2] hover:shadow-lg transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                  </svg>
                </a>
                <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-full shadow-md flex items-center justify-center text-gray-600 hover:text-[#000000] hover:shadow-lg transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
                ...
                <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-full shadow-md flex items-center justify-center text-gray-600 hover:text-[#E4405F] hover:shadow-lg transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.9 3.9 0 0 0-1.417.923A3.9 3.9 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04.852.174 1.433.372 1.942.205.526.478.972.923 1.417.444.445.89.719 1.416.923.51.198 1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.9 3.9 0 0 0 1.416-.923c.445-.445.718-.891.923-1.417.197-.509.332-1.09.372-1.942C15.99 10.445 16 10.173 16 8s-.01-2.445-.048-3.299c-.04-.851-.175-1.433-.372-1.941a3.9 3.9 0 0 0-.923-1.417A3.9 3.9 0 0 0 13.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 10.172 0 7.998 0zm-.717 1.442h.718c2.136 0 2.389.007 3.232.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599.28.28.453.546.598.92.11.281.24.705.275 1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.5 2.5 0 0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.5 2.5 0 0 1-.92-.598 2.5 2.5 0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233s.008-2.388.046-3.231c.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92.28-.28.546-.453.92-.598.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045zm4.988 1.328a.96.96 0 1 0 0 1.92.96.96 0 1 0 0-1.92zm-4.27 1.122a4.109 4.109 0 1 0 0 8.217 4.109 4.109 0 1 0 0-8.217zm0 1.441a2.667 2.667 0 1 1 0 5.334 2.667 2.667 0 0 1 0-5.334" />
                  </svg>
                </a>
                <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-full shadow-md flex items-center justify-center text-gray-600 hover:text-[#0A66C2] hover:shadow-lg transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div className="flex flex-col items-start">
              <h3 className="text-[#F5B82E] font-semibold mb-4 text-base sm:text-lg">YENQUIT</h3>
            ...
            {/* Contact */}
            <div className="flex flex-col items-start">
              <h3 className="text-[#F5B82E] font-semibold mb-4 text-base sm:text-lg">CONTACT</h3>
            ...
            {/* Newsletter */}
            <div className="flex flex-col items-start">
              <h3 className="text-[#F5B82E] font-semibold mb-4 text-base sm:text-lg">NEWSLETTER</h3>
              ...
              <div className="flex bg-white rounded-full overflow-hidden shadow-md w-full max-w-xs">
                <input
                  ...
                  className="px-3 sm:px-4 py-2 sm:py-3 text-sm text-gray-700 bg-transparent outline-none w-full placeholder-gray-400"
                />
                <button className="bg-gradient-to-r from-[#FFC107] to-[#FFD54F] text-white text-sm font-semibold px-3 sm:px-4 py-2 sm:py-3 transition-all duration-300 hover:shadow-inner">
                  SUBMIT
                </button>
              </div>
            </div>
